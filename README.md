This project fetches user data from JSON Placeholder and displays it in cards on the main page. Additionally, it provides a feature to view the posts of each user on a separate page.
